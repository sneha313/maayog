						...
						<form action="<?php  echo base_url('Admin/index'); ?>" id="forgotpassword" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<button type="submit" class="btn btn-info InfoBtn btn-block">Submit</button>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<button type="button" class="btn btn-info InfoBtn btn-block" onclick=" window.history.go(-1)">Back</button>
								</div>
							</div>
						</form>
					</div>
