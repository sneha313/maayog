                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown NotificationIcon">
								...
								<?php }  ?>
									<li>
                                        <a class="MoreNotify" href="<?php echo base_url('notification');?>">More Notification</a>
									</li>
								<?php } else { ?>
									<li>
								  ...
								  <div id="myDropdown" class="dropdown-content">
										...
										<div class="row text-center DropRow">
											<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 DropBtn">
												<a href="<?php echo base_url('user-profile'); ?>"class="btn btn-sm btn-info InfoBtn btn-block"><i class="fa fa-user icon">&nbsp;&nbsp;&nbsp;</i>Profile</a>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 DropBtn">
