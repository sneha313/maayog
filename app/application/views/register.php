			...
			<div class="content margin-top-10per">
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xs-offset-0 col-sm-offset-3  col-md-offset-4 col-lg-offset-4">
						...
						<div class="alert alert-success" style="display:none;"><i data-notify="icon" class="material-icons">add_alert</i>
						...
						<div class="card card-register">
							...
							<div class="card-content">
								<form id="registerPage" action="<?php echo base_url('User/registerUser'); ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<button type="submit" class="btn btn-info btn-block InfoBtn">Register</button>
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
											<a class="text-info" href="<?php echo base_url('login'); ?>">ALREADY HAVE AN ACCOUNT?</a>
										</div>
									</div>
								</form>
							</div>
