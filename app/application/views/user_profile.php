		...
		<div class="col-md-9">
			...
			<div class="row Profile-detail">
					...
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
						...
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<i class="fa fa-tasks icon" aria-hidden="true" title="Class Name"></i>
								<span  title="Class Name <?php echo (!empty($class_name['ClassName'])) ? $class_name['ClassName'] : 'Class Not Assigned Yet'; ?>"><?php echo (!empty($class_name['ClassName'])) ? $class_name['ClassName'] : 'Class Not Assigned Yet'; ?></span>
							</div>
						</div>
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
