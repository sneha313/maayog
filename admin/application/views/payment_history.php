											...
											<?php 
												if(!empty($ind_payment_history)) { 
													...
													<tr>
														...
														<td><a href="javascript:void(0)" title="click here to see details"><?php echo $indPay['ORDERID']; ?></a></td>
											...
											<table class="table" id="allPayment">
												...
												if(!empty($all_payment_history)) { 
													...
													<tr>
														...
														<td><a href="javascript:void(0)" title="click here to see details"><?php echo $allPay['ORDERID']; ?></a></td>
											...
											<table class="table" id="corpPayment">
												...
												if(!empty($cor_payment_history)) { 
													...
													<tr>
														...
														<td><a href="javascript:void(0)" title="click here to see details"><?php echo $corPay['ORDERID']; ?></a></td>
