										...
										<div class="col-xs-12 col-sm-6  col-md-6 col-lg-6 col-xl-6">
											<div class="form-group label-floating">
												...
												<div class="DateofBirth">
													<input type="text" id="dob" data-format="DD-MM-YYYY" data-template="D MMM YYYY" name="DOB" value="<?php echo (!empty($edit_Instructor_data_byId['InstrucEmail'])) ? $edit_Instructor_data_byId['InstrucEmail'] : ''; ?>">
												</div>
											</div>
										</div>
										<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
