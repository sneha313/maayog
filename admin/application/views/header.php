            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
								<div class="dropdown" style="float:right;">
								  <img onclick="myFunction()" class="img-responsive user-profile dropbtn" src="<?php echo base_url('assets/img/faces/user.jpg'); ?>">
                        ...
                        <!--form class="navbar-form text-center" action="" role="search">
                            <div class="form-group is-empty">
                                <input type="text" class="form-control SearchWidth" name="Search" placeholder="Search">
