		...
		fields: {
			CompanyName: {
				...
				validators: {
					...
					remote: {
                        message: 'This company name is already exist, Please enter different company name',
                        type: 'POST',
                        url: base_url+'Admin/check_corp',
                        dataType: 'JSON',
                    },
					regexp: {
			...
			// MapLink: {
				...
				// validators: {
					...
					// },
					// regexp: {
						// regexp:  /(http|https)?:(//www.google.co.in/maps)/,
						// message: 'Please provide valid map URL'
					// }
				// }
			// },
			// PhotoUpload: {
