...
<div class="content">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="alert alert-success text-center" style="display:none;">
				<span><i class="material-icons">check_circle</i> Profile Edited Successfully</span>
			</div>
	...
	<div class="row UserProfileBackground">
						...
						<div class="ProfileHeader places-sweet-alerts">
							<strong>
								<h4><?php echo (!empty($user_profile['FirstName'])) ? ucwords($user_profile['FirstName']).' '.ucwords($user_profile['LastName']) : ''; ?>
									<a href="<?php echo base_url('edit-user-detail'); ?>"><i class="fa fa-pencil icon" id="edit" title="Edit Profile"></i></a>
									
								</h4>
							</strong>
						</div>
						<div class="SubHeader">
							<span><?php echo ((!empty($user_profile['Role'])) && ($user_profile['Role'])=='1') ? 'User' : '';?></span>
						</div>
					</div>
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
						<div class="ProfileHeader">
							<a href="javascript:void(0);" class="btn btn-rose ChangePassBtn"><i class="fa fa-unlock-alt icon" id="changePassword" title="Change Password"></i>Change Password</a>
						</div>
					</div>
				</div>
					...
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<span title="Date of Birth <?php 
										echo (!empty($user_profile['DateOfBirth'])) ? $values['mday']." ".$monthName.", ".$values['year'] : ''; 
									?>">
									<?php 
										echo (!empty($user_profile['DateOfBirth'])) ? $values['mday']." ".$monthName.", ".$values['year'] : ''; 
									?>
						...
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<span title="Mobile Number <?php echo (!empty($user_profile['EmailAddress'])) ? $user_profile['EmailAddress'] : ''; ?>"><?php echo (!empty($user_profile['EmailAddress'])) ? $user_profile['EmailAddress'] : ''; ?></span>
							</div>
						</div>
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
						...
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<span  title="Batch Name <?php echo (!empty($user_profile['BatchName'])) ? $user_profile['BatchName'] : 'Class Not Assigned Yet'; ?>"><?php echo (!empty($user_profile['BatchName'])) ? $user_profile['BatchName'] : 'Class Not Assigned Yet'; ?></span>
							</div>
						</div>
						<!--div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" title="TimeSlot">
								<i class="fa fa-clock-o icon" aria-hidden="true"></i>
								<span title="Class Time <?php echo (!empty($user_profile['TimeSlot'])) ? $user_profile['TimeSlot'] : 'Not Available Yet'; ?>"><?php echo (!empty($user_profile['TimeSlot'])) ? $user_profile['TimeSlot'] : 'Not Available Yet'; ?></span>
							</div>
						</div-->
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<i class="fa fa-map-marker icon" aria-hidden="true" title="Address"></i>
								<span title="Address Detail <?php echo (!empty($user_profile['City']) && !empty($user_profile['State'])) ? $user_profile['City']." ,".$user_profile['State']: ''; ?>"><?php echo (!empty($user_profile['City']) && !empty($user_profile['State'])) ? $user_profile['City']." ,".$user_profile['State']: ''; ?></span>
							</div>
						</div>
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<i class="fa fa-map-marker icon" aria-hidden="true" title="PinCode"></i>
								<span title="PinCode <?php echo (!empty($user_profile['PinCode'])) ? $user_profile['PinCode']: ''; ?>"><?php echo (!empty($user_profile['PinCode'])) ? $user_profile['PinCode']: ''; ?></span>
							</div>
						</div>
						<div class="UserDetail row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<i class="fa fa-map-marker icon" aria-hidden="true" title="Country"></i>
				...
				<div class="row ">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="row Health">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<strong><span title="Health Issue<?php echo (!empty($user_profile['HealthCondition'])) ? " ".(($user_profile['HealthCondition']=='concern') ? " - ".$health_problem['HealthProblemName'] : "Noconcern"): ''; ?>"><?php echo (!empty($user_profile['HealthCondition'])) ? (($user_profile['HealthCondition']=='concern') ? "concern - ( ".$health_problem['HealthProblemName']." )" : "Noconcern"): ''; ?></span></strong>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-md-3" id="imageMar25px">
  ...
  <div class="modal-dialog" role="document">
	<div class="card card-modal">
	   ...
	   <div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group label-floating is-empty bmd-form-group">
					...
					<input type="password" name="CurrentPassword" class="form-control CurrentPassword">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group label-floating is-empty bmd-form-group">
					...
					<input type="password" name="ConfirmPassword" class="form-control ConfirmPassword">
				<span class="material-input"></span></div>
			</div>
		</div>
	  </div>
	  ...
	  <div class="modal-footer CardModalfooter">
		...
		<button type="button" class="btn btn-rose pull-right" data-dismiss="modal">Cancel</button>
	  </div>
			...
			// $.ajax({
					...
					// success: function(result){
						...
						// }
						  ...
						  // $('#dob').val(result.user_profile.DateOfBirth);
						  ...
						  // healthProblemId=result.health_prob.HealthId;
						    // $.ajax({
							 // type: "POST",
							 // url: base_url+'User/get_healthProblem',
							 // dataType: 'JSON',
							 // success: function(result){
		...
		// if (type == 'input-field') {
			...
			// }).then(function(result) {
				...
				// if(result.value){
					...
					// $.ajax({
						// url: base_url+"User/updateUserDetail",
						// type: "post",
						// data: form_data,
						// success: function(res){
							// if(res){
								...
								// html: 'Your Profile deatil is updated successfully: <strong>' +
									// $('#editUserDetail').find('input[name="FirstName"]').val() +" "+$('#editUserDetail').find('input[name="LastName"]').val()+
									// '</strong>',
